    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                sh "AWS_ACCESS_KEY_ID=${env.AWS_ACCESS_KEY_ID} AWS_SECRET_ACCESS_KEY=${env.AWS_SECRET_ACCESS_KEY} aws cloudfront create-invalidation --distribution-id E2CE9ZVU5SR5TP --paths '/*'"
            }
        }
    }
    options{
