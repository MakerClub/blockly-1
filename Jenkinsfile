    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                sh "AWS_ACCESS_KEY_ID=${env.AWS_ACCESS_KEY_ID} AWS_SECRET_ACCESS_KEY=${env.AWS_SECRET_ACCESS_KEY} aws s3 cp blocks_compressed.js  --region us-west-2 s3://stage.invent.org/blockly --cache-control max-age=600"
